import {nuevoArcontent,showTemplate,imprimirOptions,filterForCategory,filterForText,filtroCross} from "../javascript/module/funtionsUpComing.js"
...
.then(datos => {events = datos.events
  ...
  for (let contenido of newEvenet){ // aca filtro las fechas correspondientes a evento pasado
      if (contenido.date >= "2023-03-10"){ // aca lo mismo que past pero invertido
